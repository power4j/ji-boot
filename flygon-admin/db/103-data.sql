-- sys user
INSERT INTO `t_sys_user`(`id`, `op_flag`, `del_flag`, `create_by`, `create_at`, `update_by`, `update_at`, `username`, `password`, `salt`, `name`, `mail`, `mobile_phone`, `remarks`, `status`)
VALUES (1, 0, NULL, NULL, NOW(), NULL, NULL, 'admin', '$2a$10$OO/CElRgmt9nhFQsHDDs3ulWkTcZ5/4t09YVMVU9Y8AzDthkm6lWO', NULL, '管理员', null, '18081020301', '初始用户', 0);

-- 字典
INSERT INTO `t_sys_dict`(`id`, `op_flag`, `del_flag`, `create_at`, `update_at`, `code`, `name`, `remarks`)
VALUES (10001, 1, NULL, NOW(), NULL, 'sys_menu_type', '菜单类型', NULL);
INSERT INTO `t_sys_dict_item`(`id`, `op_flag`, `del_flag`, `create_at`, `update_at`, `dict_id`, `value`, `label`, `remarks`)
VALUES (20001, 1, NULL, NOW(), NULL, 10001, '1', '菜单', NULL);
INSERT INTO `t_sys_dict_item`(`id`, `op_flag`, `del_flag`, `create_at`, `update_at`, `dict_id`, `value`, `label`, `remarks`)
VALUES (20002, 1, NULL, NOW(), NULL, 10001, '2', '按钮', NULL);
INSERT INTO `t_sys_dict_item`(`id`, `op_flag`, `del_flag`, `create_at`, `update_at`, `dict_id`, `value`, `label`, `remarks`)
VALUES (20003, 1, NULL, NOW(), NULL, 10001, '3', '路由', '路由不会展示');

INSERT INTO `t_sys_dict`(`id`, `op_flag`, `del_flag`, `create_at`, `update_at`, `code`, `name`, `remarks`)
VALUES (10002, 1, NULL, NOW(), NULL, 'sys_user_status', '用户状态', NULL);
INSERT INTO `t_sys_dict_item`(`id`, `op_flag`, `del_flag`, `create_at`, `update_at`, `dict_id`, `value`, `label`, `remarks`)
VALUES (20004, 1, NULL, NOW(), NULL, 10002, '0', '正常', NULL);
INSERT INTO `t_sys_dict_item`(`id`, `op_flag`, `del_flag`, `create_at`, `update_at`, `dict_id`, `value`, `label`, `remarks`)
VALUES (20005, 1, NULL, NOW(), NULL, 10002, '1', '禁用', NULL);

INSERT INTO `t_sys_dict`(`id`, `op_flag`, `del_flag`, `create_at`, `update_at`, `code`, `name`, `remarks`)
VALUES (10003, 1, NULL, NOW(), NULL, 'sys_user_status', '参数状态', NULL);
INSERT INTO `t_sys_dict_item`(`id`, `op_flag`, `del_flag`, `create_at`, `update_at`, `dict_id`, `value`, `label`, `remarks`)
VALUES (20006, 1, NULL, NOW(), NULL, 10003, '0', '正常', NULL);
INSERT INTO `t_sys_dict_item`(`id`, `op_flag`, `del_flag`, `create_at`, `update_at`, `dict_id`, `value`, `label`, `remarks`)
VALUES (20007, 1, NULL, NOW(), NULL, 10003, '1', '禁用', NULL);

-- 资源根节点
INSERT INTO `t_sys_resource`(`id`, `op_flag`, `del_flag`, `create_at`, `update_at`, `type`, `name`, `title`, `permission`, `path`, `component`, `icon`, `sort`)
