...
(
  ...
  `op_flag`     TINYINT     NOT NULL DEFAULT 0 COMMENT '数据标记 0 普通数据, 1 系统保护数据',
...
ALTER TABLE `t_sys_user` ADD INDEX `idx_op_flag` (`op_flag`);
...
(
    ...
    `permission`  VARCHAR(255) NOT NULL COMMENT '权限代码',
    `path`        VARCHAR(255) NOT NULL COMMENT '前端路径',
