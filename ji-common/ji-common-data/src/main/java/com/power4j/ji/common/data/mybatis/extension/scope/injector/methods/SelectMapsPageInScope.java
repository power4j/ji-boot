 ...
 * @since 1.0
 */
public class SelectMapsPageInScope extends AbstractMethod {

	@Override
	public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
		ScopeSupportMethods method = ScopeSupportMethods.SELECT_MAPS_PAGE;
		...
		return this.addSelectMappedStatementForOther(mapperClass, method.getName(), sqlSource, Map.class);
	}
